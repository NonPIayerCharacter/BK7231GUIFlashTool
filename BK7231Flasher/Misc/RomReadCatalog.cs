...
namespace BK7231Flasher
{
    ...
    public static class RomReadCatalog
    {
        ...
        static readonly IReadOnlyList<RomReadTarget> Targets = new List<RomReadTarget>()
        {
            ...
            new RomReadTarget(BKType.BK7236, RomReadKind.Rom, "ROM", 0x16000000, 0x10000, 115200, CommonSerialBauds, BekenNonSecureRomSpace, BekenRomBackend, BekenRomController),
